import { ElementType, Monster, WeaponMotionType } from '../types/game';
  ...
  return (
    <div className={`relative flex items-center justify-center select-none ${className}`}>
      ...
      >
        ...
        {/* 속성별 고유 픽셀 그래픽 */}
        {element === '불' && <FireMonsterPixels isBoss={isBoss} />}
        {element === '물' && <WaterMonsterPixels isBoss={isBoss} />}
        {element === '나무' && <WoodMonsterPixels isBoss={isBoss} />}
        {element === '땅' && <EarthMonsterPixels isBoss={isBoss} />}
        {element === '쇠' && <MetalMonsterPixels isBoss={isBoss} />}
      </svg>
    </div>
  );
}

// 1. 불 속성 몬스터 픽셀 (화염 뿔, 마그마 슬라임/골렘 형태)
function FireMonsterPixels({ isBoss }: { isBoss: boolean }) {
  return (
    <g>
      {/* 불꽃 날개/아우라 */}
      <rect x="5" y="10" width="3" height="6" fill="#ea580c" />
      <rect x="24" y="10" width="3" height="6" fill="#ea580c" />
      <rect x="4" y="12" width="2" height="5" fill="#f97316" />
      <rect x="26" y="12" width="2" height="5" fill="#f97316" />

      {/* 뿔 (악마/이프리트 뿔) */}
      <rect x="9" y="6" width="3" height="4" fill="#7f1d1d" />
      <rect x="8" y="4" width="2" height="3" fill="#991b1b" />
      <rect x="20" y="6" width="3" height="4" fill="#7f1d1d" />
      <rect x="22" y="4" width="2" height="3" fill="#991b1b" />

      {/* 몸체 (타오르는 마그마) */}
      <rect x="8" y="10" width="16" height="17" fill="#dc2626" />
      <rect x="9" y="9" width="14" height="2" fill="#ef4444" />
      <rect x="10" y="12" width="12" height="13" fill="#f87171" />

      {/* 마그마 균열 */}
      <rect x="11" y="20" width="4" height="2" fill="#fef08a" />
      <rect x="14" y="21" width="3" height="3" fill="#facc15" />
      <rect x="17" y="19" width="4" height="2" fill="#fef08a" />

      {/* 불타는 눈 (황금빛 발광) */}
      <rect x="11" y="13" width="3" height="3" fill="#fef08a" />
      <rect x="18" y="13" width="3" height="3" fill="#fef08a" />
      <rect x="12" y="14" width="1" height="1" fill="#7f1d1d" />
      <rect x="19" y="14" width="1" height="1" fill="#7f1d1d" />

      {/* 입 */}
      <rect x="14" y="17" width="4" height="2" fill="#450a0a" />
      <rect x="15" y="17" width="2" height="1" fill="#ffffff" />
    </g>
  );
}

// 2. 물 속성 몬스터 픽셀 (심해 아귀/서리 정령 형태)
function WaterMonsterPixels({ isBoss }: { isBoss: boolean }) {
  return (
    <g>
      {/* 지느러미 / 얼음 결정 */}
      <rect x="4" y="14" width="4" height="6" fill="#0284c7" />
      <rect x="24" y="14" width="4" height="6" fill="#0284c7" />
      <rect x="3" y="16" width="2" height="3" fill="#38bdf8" />
      <rect x="27" y="16" width="2" height="3" fill="#38bdf8" />

      {/* 심해 발광체/안테나 */}
      <rect x="15" y="4" width="2" height="5" fill="#0369a1" />
      <rect x="14" y="3" width="4" height="3" fill="#38bdf8" />
      <rect x="15" y="4" width="2" height="1" fill="#ffffff" />

      {/* 몸체 (청록 심해 바디) */}
      <rect x="8" y="9" width="16" height="18" fill="#0284c7" />
      <rect x="10" y="8" width="12" height="2" fill="#38bdf8" />
      <rect x="10" y="11" width="12" height="14" fill="#0ea5e9" />

      {/* 심해 물방울 빛반사 */}
      <rect x="11" y="10" width="2" height="2" fill="#e0f2fe" />
      <rect x="12" y="21" width="3" height="3" fill="#7dd3fc" />

      {/* 발광하는 청백색 눈 */}
      <rect x="11" y="13" width="3" height="3" fill="#ffffff" />
      <rect x="18" y="13" width="3" height="3" fill="#ffffff" />
      <rect x="12" y="14" width="2" height="2" fill="#0c4a6e" />
      <rect x="19" y="14" width="2" height="2" fill="#0c4a6e" />

      {/* 날카로운 서리 이빨 */}
      <rect x="13" y="18" width="6" height="2" fill="#082f49" />
...
// 3. 나무 속성 몬스터 픽셀 (고목 엔트/나뭇잎 정령)
function WoodMonsterPixels({ isBoss }: { isBoss: boolean }) {
  return (
    <g>
      {/* 머리 위 나뭇잎 관 */}
      <rect x="10" y="4" width="12" height="4" fill="#15803d" />
      <rect x="13" y="2" width="6" height="3" fill="#22c55e" />
      <rect x="15" y="1" width="2" height="2" fill="#86efac" />
      <rect x="7" y="6" width="4" height="4" fill="#166534" />
      <rect x="21" y="6" width="4" height="4" fill="#166534" />

      {/* 나뭇가지 어깨/팔 */}
      <rect x="4" y="13" width="5" height="5" fill="#713f12" />
      <rect x="23" y="13" width="5" height="5" fill="#713f12" />
      <rect x="3" y="11" width="3" height="3" fill="#22c55e" />
      <rect x="26" y="11" width="3" height="3" fill="#22c55e" />

      {/* 고목 나무 몸체 */}
      <rect x="8" y="8" width="16" height="19" fill="#854d0e" />
      <rect x="10" y="10" width="12" height="15" fill="#a16207" />

      {/* 나이테 및 덩굴 무늬 */}
      <rect x="12" y="19" width="3" height="4" fill="#4d7c0f" />
      <rect x="17" y="20" width="3" height="5" fill="#4d7c0f" />
      <rect x="11" y="11" width="1" height="7" fill="#713f12" />

      {/* 에메랄드 영혼의 눈 */}
      <rect x="11" y="13" width="3" height="3" fill="#4ade80" />
      <rect x="18" y="13" width="3" height="3" fill="#4ade80" />
      <rect x="12" y="14" width="1" height="1" fill="#14532d" />
      <rect x="19" y="14" width="1" height="1" fill="#14532d" />

      {/* 입 */}
      <rect x="14" y="17" width="4" height="2" fill="#422006" />
    </g>
  );
}

// 4. 땅 속성 몬스터 픽셀 (바위 골렘/모래 전갈 형태)
function EarthMonsterPixels({ isBoss }: { isBoss: boolean }) {
  return (
    <g>
      {/* 머리 위 화강암 돌기 */}
      <rect x="11" y="4" width="4" height="4" fill="#78350f" />
      <rect x="17" y="5" width="4" height="4" fill="#92400e" />
      <rect x="14" y="3" width="4" height="3" fill="#b45309" />

      {/* 어깨 거석 바위 */}
      <rect x="4" y="11" width="5" height="7" fill="#78350f" />
      <rect x="23" y="11" width="5" height="7" fill="#78350f" />

      {/* 몸체 (단단한 암석 블록) */}
      <rect x="8" y="8" width="16" height="19" fill="#92400e" />
      <rect x="10" y="9" width="12" height="16" fill="#b45309" />
      <rect x="12" y="11" width="8" height="12" fill="#d97706" />

      {/* 황토빛 균열 코어 */}
      <rect x="14" y="18" width="4" height="5" fill="#fde047" />
      ...
      <rect x="19" y="14" width="1" height="1" fill="#451a03" />

      {/* 입 */}
      <rect x="13" y="17" width="6" height="1" fill="#451a03" />
    </g>
  );
}

// 5. 쇠 속성 몬스터 픽셀 (증기 태엽 기계병/기사)
function MetalMonsterPixels({ isBoss }: { isBoss: boolean }) {
  return (
    <g>
      {/* 머리 위 태엽 톱니 */}
      <rect x="14" y="3" width="4" height="4" fill="#cbd5e1" />
      <rect x="13" y="2" width="6" height="2" fill="#94a3b8" />
      <rect x="15" y="1" width="2" height="4" fill="#64748b" />

      {/* 강철 견갑 / 증기 배기 파이프 */}
      <rect x="4" y="11" width="5" height="6" fill="#64748b" />
      <rect x="23" y="11" width="5" height="6" fill="#64748b" />
      <rect x="5" y="8" width="2" height="3" fill="#94a3b8" />
      <rect x="25" y="8" width="2" height="3" fill="#94a3b8" />

      {/* 강철 중장갑 몸체 */}
      <rect x="8" y="7" width="16" height="20" fill="#475569" />
      <rect x="10" y="8" width="12" height="17" fill="#64748b" />
      <rect x="11" y="10" width="10" height="13" fill="#94a3b8" />
      ...
      {/* 기계 붉은 광학 바이저 / 렌즈 */}
      <rect x="10" y="12" width="12" height="3" fill="#1e293b" />
      <rect x="11" y="13" width="4" height="1" fill="#ef4444" />
      <rect x="17" y="13" width="4" height="1" fill="#ef4444" />
      ...
      <rect x="21" y="9" width="1" height="1" fill="#cbd5e1" />
      <rect x="10" y="23" width="1" height="1" fill="#cbd5e1" />
      <rect x="21" y="23" width="1" height="1" fill="#cbd5e1" />
    </g>
  );
}
